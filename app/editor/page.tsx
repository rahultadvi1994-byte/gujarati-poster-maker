...
export default function EditorPage() {
  ...
  useEffect(() => {
    ...
    function handleSelection(e: any) {
      ...
      if (!obj) return;
      const key = (Object.keys(textObjectsRef.current) as TextLayerKey[]).find(
        (k) => textObjectsRef.current[k] === obj
      );
      if (key) {
        ...
        <div className="flex items-center gap-3">
          <Link href="/">
            <Button variant="ghost" size="sm" className="gap-2">
              ...
              <span className="hidden sm:inline">ઘર પાછા જાઓ</span>
              <span className="sm:hidden">ઘર</span>
            </Button>
          </Link>
            ...
            <div className="space-y-6 p-5">
              <section>
                <div className="mb-3 flex items-center gap-2">
                  ...
                  <h3 className="text-sm font-semibold text-foreground">લખાણ દાખલ કરો</h3>
                </div>
              ...
              <section className="rounded-lg bg-muted/50 p-4">
                ...
                <ul className="space-y-1.5 text-xs text-muted-foreground">
                  <li>• લખાણ ખસેડવા માટે ક્લિક કરીને ખેંચો</li>
                  <li>• મોટું/નાનું કરવા ખૂણા ખેંચો</li>
                  <li>• ફેરવવા ઉપરનું નિશાન ઘુમાવો</li>
                  <li>• ફોન્ટ બદલવા લખાણ પર ક્લિક કરો</li>
                </ul>
              </section>
            </div>
          </ScrollArea>
